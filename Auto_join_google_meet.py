# As google won't let you login from an automated script so used 
# stackoverflow insted of Google
# Only dependency needed is selenium (pip install selenium)
...
driver = webdriver.Chrome(executable_path="Chrome_driver_path # e.g C:\Drivers\chromedriver.exe")
